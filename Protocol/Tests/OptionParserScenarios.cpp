...
SCENARIO( OptionParser, "Construction/Normal", "OptionParser can be constructed." )
{
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse enum option." )
{
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse enum value option." )
{
    shared_ptr<Protocol::ProtoModel> model;
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse message option." )
{
    shared_ptr<Protocol::ProtoModel> model;
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse message field option." )
{
    shared_ptr<Protocol::ProtoModel> model;
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse oneof option." )
{
    shared_ptr<Protocol::ProtoModel> model;
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse oneof field option." )
{
    shared_ptr<Protocol::ProtoModel> model;
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse proto option." )
{
    shared_ptr<Protocol::ProtoModel> model;
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse floating point option value." )
{
    shared_ptr<Protocol::ProtoModel> model;
...
SCENARIO( OptionParser, "Parsing/Normal", "OptionParser can parse string option value." )
{
    shared_ptr<Protocol::ProtoModel> model;
